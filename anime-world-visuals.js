(() => {
  ...
  style.id = STYLE_ID;
  style.textContent = `
    .world{isolation:isolate;background:linear-gradient(180deg,#aee2ff 0%,#dff5ff 37%,#f8fcff 53%,#dff6dc 100%);border-color:rgba(135,199,240,.72);box-shadow:0 22px 55px rgba(64,121,180,.22),inset 0 0 0 1px rgba(255,255,255,.68);overflow:hidden}
    .world:before{content:"";position:absolute;left:-6%;right:-6%;bottom:-15%;height:42%;z-index:1;pointer-events:none;background:radial-gradient(ellipse at 16% 20%,#9bd690 0 17%,transparent 18%),radial-gradient(ellipse at 47% 25%,#80c984 0 20%,transparent 21%),radial-gradient(ellipse at 82% 18%,#a9dc8e 0 18%,transparent 19%);filter:drop-shadow(0 -8px 18px rgba(68,133,93,.12))}
    ...
    .world-copy{z-index:6;filter:drop-shadow(0 3px 10px rgba(255,255,255,.85))}
    ...
    .hero-avatar{z-index:7;border:2px solid rgba(255,255,255,.94);box-shadow:0 15px 34px rgba(48,101,164,.22),0 0 0 7px rgba(255,255,255,.24),inset 0 1px rgba(255,255,255,.9);transition:transform .24s ease,box-shadow .24s ease}
    .hero-avatar:hover{transform:translateY(-5px) scale(1.025);box-shadow:0 20px 42px rgba(48,101,164,.28),0 0 0 9px rgba(255,255,255,.22)}
    .hero-avatar:after{content:"★ HERO";position:absolute;left:50%;bottom:-13px;transform:translateX(-50%);white-space:nowrap;font:800 9px/1 system-ui,sans-serif;letter-spacing:.12em;color:#654fae;background:rgba(255,255,255,.94);border:1px solid rgba(123,99,196,.2);border-radius:999px;padding:5px 8px;box-shadow:0 5px 12px rgba(68,81,128,.12)}
    .float-label{z-index:7;border:1px solid rgba(255,255,255,.88);backdrop-filter:blur(12px);animation:lvFloat 4.2s ease-in-out infinite;box-shadow:0 8px 20px rgba(55,100,148,.13)}
    ...
    .zone-node.z1:before{background:linear-gradient(145deg,#73d59c,#3cae7a)}.zone-node.z2:before{background:linear-gradient(145deg,#79c6ff,#597ee8)}.zone-node.z3:before{background:linear-gradient(145deg,#ffd56d,#f39a61)}.zone-node.z4:before{background:linear-gradient(145deg,#9a8cff,#6e62d8)}.zone-node.z5:before{background:linear-gradient(145deg,#64d9d2,#3b9fc5)}.zone-node.z6:before{background:linear-gradient(145deg,#ffd76d,#ff9f6c)}
    .zone-node.current{outline:4px solid rgba(255,255,255,.45);outline-offset:4px;animation:lvZoneAura 2s ease-in-out infinite}.zone-node.done{box-shadow:0 12px 30px rgba(53,163,119,.18)}.zone-node.locked{backdrop-filter:blur(5px);filter:grayscale(.72) saturate(.55);opacity:.62}
    .zone-node .modern-icon{filter:drop-shadow(0 4px 5px rgba(50,78,105,.16));transition:transform .22s ease}.zone-node:not(:disabled):hover .modern-icon{transform:scale(1.14) rotate(-3deg)}.zone-legend{border:1px solid rgba(255,255,255,.82);backdrop-filter:blur(12px)}
    ...
    @media(max-width:760px){
      ...
      .six-zone-map{border-radius:24px}.zone-node{backdrop-filter:none;background:rgba(255,255,255,.94)}.zone-node:not(:disabled):hover{transform:none}.zone-node.current{outline-width:3px;outline-offset:2px}.zone-node.locked{backdrop-filter:none}
    }
    @media(max-width:420px){.world{min-height:360px}.world-copy h3{font-size:26px}.world-copy{max-width:84%}.float-label{max-width:42%;white-space:normal;line-height:1.2}}
    @media(prefers-reduced-motion:reduce){.float-label,.map-node.current,.goal-node.current,.world .scene:after,.zone-node.current{animation:none!important}.zone-node,.hero-avatar{transition:none!important}}
  `;
